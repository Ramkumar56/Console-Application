...
public class BookingView {
    ...
    public void booking() {
        ...
        for(Map.Entry<Integer, Flight>flightEntry: Database.flightDatabase.entrySet()){
            ...
            System.out.println("Flight DeparureTime:"+flightEntry.getValue().getDepartureTime());
    ...
    public void display(int pnrNumber, HashMap<Integer, List<Passenger>> bookedPassengers) {
        System.out.println("Your Tickets Successfully Booked");
          for(int i=0;i<bookedPassengers.get(pnrNumber).size();i++){
            ...
            System.out.println("\nPassenger Id:"+bookedPassengers.get(pnrNumber).get(i).getId());
            System.out.println("\nPassenger Age:"+bookedPassengers.get(pnrNumber).get(i).getAge());
            System.out.println("\nPassenger Gender:"+bookedPassengers.get(pnrNumber).get(i).getGender());
